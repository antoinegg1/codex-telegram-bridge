...
export type CallbackAction =
  ...
  | { type: "continueThread"; threadId: string }
  | { type: "terminateThread"; threadId: string; requestId?: string }
  | { type: "answerChoice"; requestId: string; questionId: string; answer: string };
...
export interface CodexController {
  ...
  answerUserInput(serverRequestId: string | number, answers: Record<string, { answers: string[] }>): Promise<void>;
